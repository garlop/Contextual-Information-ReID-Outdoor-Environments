...
def create_dataset(
    ...
    part='trainval',
    **kwargs):
  assert name in ['market1501', 'cuhk03', 'duke', 'combined', 'custom'], \
  ...
  if name == 'market1501':
    im_dir = ospeu('~/Escritorio/images')
    partition_file = ospeu('~/Escritorio/partitions.pkl')
    ...
    im_dir = ospeu('~/Documentos/Luis/PyTorch-YOLOv3/labeledNew')
    partition_file = ospeu('~/Documentos/Luis/PyTorch-YOLOv3/filesNames.pkl')
