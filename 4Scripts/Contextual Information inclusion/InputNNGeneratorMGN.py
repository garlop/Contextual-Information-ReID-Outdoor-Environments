...
with open('../../8Data Features and Context Jsons/dataMGNFeatures.json', 'r') as imagesFeatures:
...
with open('../../9Data Features and Context csv/data3MGN.csv', 'a+', newline='') as csvData:
